...
-   单一架构
    ...
    ![image_ubxbkc-DZ5](./assets/image_ubxbkc-DZ5.png)
...
-   **3.2.1 普通和复杂容器**
    ...
    **普通容器**
    ...
    ![img](./assets/quality,Q_100&file_size=42385.webp)
    > 普通容器只能用来存储，没有更多功能。
    > 程序中的普通容器
    -   数组
    -   集合：List
    ...
    !![img](./assets/quality,Q_100&file_size=11277.webp)
...
2.  思路
    ...
    ![img](./assets/quality,Q_100&file_size=13315.webp)
3.  准备项目
...
```
        ...
        -   constructor-arg标签：可以引用构造参数 ref引用其他bean的标识。
        						value =  直接属性值 String name = "张三"  二选一
...
1.  **注解理解**
    ...
    ![img](./assets/quality,Q_100&file_size=15402.webp)
...
3.  **@Autowired注解细节**
    ...
    2.  工作流程
        ...
        ![img](https://secure2.wostatic.cn/static/t6b5ZcCjFAhvshhZXUHvtp/img018.png?auth_key=1722485529-hHHouxwJu2WnoPYqtLn4NQ-0-ce3a0130c6e5d59895a165300878f85d&image_process=resize,w![img](https://secure2.wostatic.cn/static/t6b5ZcCjFAhvshhZXUHvtp/img018.png?auth_key=1722485529-hHHouxwJu2WnoPYqtLn4NQ-0-ce3a0130c6e5d59895a165300878f85d&image_process=resize,w_432/format,webp/quality,Q_100&file_size=18850)_432/format,webp/quality,Q_100&file_size=18850)
...
4.  声明带日志接口实现
    ...
    ![img](./assets/quality,Q_100&file_size=38118.webp)
    ```java
    package com.atguigu.proxy;
...
1.  **代理模式**
    ...
    ![img](./assets/quality,Q_100&file_size=12545.webp)

    有代理场景：

    ![img](./assets/quality,Q_100&file_size=36859.webp)
...
3.  **动态代理**
    ...
    -   cglib：通过继承被代理的目标类实现代理，所以不需要目标类实现接口！（认干爹）
        JDK动态代理技术实现（了解）
        ![img](./assets/quality,Q_100&file_size=41866.webp)
...
3.  **AOP术语名词介绍**
    ...
    ![img](./assets/quality,Q_100&file_size=44058.webp)
    ...
    -   环绕通知：使用try...catch...finally结构围绕整个被代理的目标方法，包括上面四种通知对应的所有位置
        ![img](./assets/quality,Q_100&file_size=47664.webp)
        3-连接点 joinpoint
    ...
    ![img](./assets/quality,Q_100&file_size=179895.webp)
    ...
    ![img](./assets/quality,Q_100&file_size=40346.webp)
...
![img](./assets/quality,Q_100&file_size=32865.webp)
...
1.  **切点表达式作用**
    ...
    ![img](./assets/quality,Q_100&file_size=22379.webp)
2.  **切点表达式语法**
...
![img](./assets/quality,Q_100&file_size=34616.webp)

实际意义

实际开发时，如果有多个切面嵌套的情况，要慎重考虑。例如：如果事务切面优先级高，那么在缓存中命中数据的情况下，事务切面的操作都浪费了。

![img](./assets/quality,Q_100&file_size=37986.webp)
...
![img](./assets/quality,Q_100&file_size=100510.webp)
...
1.  事务传播行为要研究的问题
    ...
    ![img](./assets/quality,Q_100&file_size=18901.webp)
